...
$iWebConfig['iWebCal_MAIN_FILENAME'] = "index.php?option=com_gcalendar&view=gcalendar2";
...
$iWebConfig['iWebCal_LOCAL_PATH'] = JPATH_SITE.DS.'components'.DS.'com_gcalendar'.DS.'views'.DS.'gcalendar2'.DS.'tmpl';
...
// iWebCal is run.
$iWebConfig['iWebCal_URL_PATH'] = JURI::base() . 'components/com_gcalendar/views/gcalendar2/tmpl';
