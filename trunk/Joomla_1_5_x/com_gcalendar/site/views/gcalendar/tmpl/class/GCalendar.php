...
<div id="calPager" class="Item"><a class="Item"
	...
	onmouseover="imageSwap('prevBtn_img', '<?php echo $urlPath ?>/img/btn-prev-over.gif')"
	onmouseout="imageSwap('prevBtn_img', '<?php echo $urlPath ?>/img/btn-prev.gif')"><?php $this->image("btn-prev.gif", "previous ${view}", "prevBtn_img"); ?></a>
<span class="ViewTitle Item"> <?php $cal->printViewTitle($year, $month, $day, $view); ?>
	...
	onmouseover="imageSwap('nextBtn_img', '<?php echo $urlPath ?>/img/btn-next-over.gif')"
	onmouseout="imageSwap('nextBtn_img', '<?php echo $urlPath ?>/img/btn-next.gif')"><?php $this->image("btn-next.gif", "next ${view}", "nextBtn_img"); ?></a>
</div>
			<?php
