...
$document->addScript(JURI::base().'components/com_gcalendar/libraries/jquery/ui/jquery-ui-1.8.5.custom.min.js');
...
$document->addStyleSheet(JURI::base().'components/com_gcalendar/libraries/jquery/themes/ui-lightness/jquery-ui-1.8.5.custom.css');
...
$calCode .= "			'<div class=\"".$class."-state-default ".$class."-corner-left ".$class."-corner-right\">'+\n";
...
$calCode .= "			'<div class=\"".$class."-state-default ".$class."-corner-left ".$class."-corner-right\">'+\n";
$calCode .= "			'<a onmouseup=\"print_view();\"><span class=\"".$class."-icon ".$class."-icon-print\">".JText::_('TOOLBAR_PRINT')."'+\n";
$calCode .= "			'</span></a>'+\n";
$calCode .= "			'</div>'+\n";
$calCode .= "			'</td>';\n";
$calCode .= "	jQuery('div.fc-button-today').parent('td').after(custom_buttons);\n";
$calCode .= "	jQuery('div.fc-button-today').closest('table.fc-header').disableSelection();\n";
