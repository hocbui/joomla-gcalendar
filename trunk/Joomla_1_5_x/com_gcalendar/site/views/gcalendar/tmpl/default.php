...
$calCode .= "		        var view = jQuery('#calendar').fullCalendar('getView').name;\n";
$calCode .= "		        jQuery('#calendar').fullCalendar('gotoDate', d);\n";
//$calCode .= "				window.location.hash = 'year='+d.getFullYear()+'&month='+(d.getMonth()+1)+'&day='+d.getDate()+'&view='+view;\n";
$calCode .= "			}\n";
$calCode .= "		});\n";
...
$calCode .= "		        if(vars[i].match(\"^year\"))tmpYear = vars[i].substring(5);\n";
...
$calCode .= "		    }\n";
$calCode .= "		    var date = new Date(tmpYear, tmpMonth, tmpDay);\n";
$calCode .= "		    var d = jQuery('#calendar').fullCalendar('getDate');alert(d+' '+date);\n";
$calCode .= "		    var view = jQuery('#calendar').fullCalendar('getView');\n";
$calCode .= "		    if(date.getFullYear() != d.getFullYear() || date.getMonth() != d.getMonth() || date.getDate() != d.getDate())\n";
$calCode .= "		        jQuery('#calendar').fullCalendar('gotoDate', date);\n";
$calCode .= "		    if(view.name != tmpView)\n";
$calCode .= "		        jQuery('#calendar').fullCalendar('changeView', tmpView);\n";
$calCode .= "		});\n";
$calCode .= "});\n";
