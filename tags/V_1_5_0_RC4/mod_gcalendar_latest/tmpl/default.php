...
<script language="JavaScript" type="text/javascript">
  ...
  var Backendl = '<?php echo JRoute::_("index.php?option=com_gcalendar&task=content&format=raw&calendarType=xmlUrl&xmlType=basic&calendarName=".$params->get('name_latest', '')."&maxResults=".$params->get('max', 5),false);?>';
