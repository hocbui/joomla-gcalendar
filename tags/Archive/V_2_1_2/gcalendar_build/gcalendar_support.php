...
<input type="hidden" name="hosted_button_id" value="302238">
<input type="image" src="https://www.paypal.com/en_US/CH/i/btn/btn_donateCC_LG.gif" border="0" name="submit" alt="">
<img alt="" border="0" src="https://www.paypal.com/en_US/i/scr/pixel.gif" width="1" height="1">
</form>

<h4>Documentation and Support</h4>
At <a href="http://gcalendar.laoneo.net" target="_blank">gcalendar.laoneo.net</a> you will find all the informations about
the project as well as a forum to post questions.
</td>
<td  valign="top">
<script type="text/javascript"><!--
google_ad_client = "pub-4081656028076034";
/* gcalendar support */
google_ad_slot = "0189053471";
google_ad_width = 120;
