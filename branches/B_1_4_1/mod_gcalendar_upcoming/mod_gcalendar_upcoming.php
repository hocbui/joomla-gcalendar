...
<script language="JavaScript" type="text/javascript">
  ...
  var Backend = '<?php echo "index2.php?option=com_gcalendar&task=content&no_html=1&calendarType=xmlUrl&xmlType=full&calendarName=".urlencode($params->get('name', ''))."&maxResults=".$params->get('max', 5);?>';
